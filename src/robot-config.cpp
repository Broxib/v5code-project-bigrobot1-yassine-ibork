...
motor Mot2 = motor(PORT12, ratio18_1, false);    /////Right Wheel
...
motor SpinMotor1 = motor(PORT17, ratio18_1, false);  /////Right Spinner
motor SpinMotor2 = motor(PORT18, ratio18_1, true); /////Left Spinner
motor release = motor(PORT11, ratio18_1, false);
...
SpinGroup.setVelocity(100,pct);
    ...
    while(Controller1.ButtonLeft.pressing()){
      if(flag==0){
      release.spinFor(fwd, 46, degrees);
      flag=1;
      }
      else{    
        release.spinFor(reverse, 46, degrees);
        flag=0;
      }
    }
    while(Controller1.ButtonB.pressing()){
      if(flag1==0){
        SpinMotor1.spin(fwd, 100, pct);
        SpinMotor2.spin(fwd, 100, pct);
        flag1=1;
      }
      else{
       SpinMotor1.stop();
